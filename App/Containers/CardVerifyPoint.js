...
let count = 1
let check = true
class CardVerifyPoint extends Component {
    ...
    _PressList = (item, index) => {
        ...
        this.props.navigation.navigate('card2')
    }
...
const mapStateToProps = (state) => {
    return {
        ...
        data: state.payment.data_cardHistory,  // data add coin by credit card
        request: state.payment.request5,  // request add coin by credit card
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getCardList: (page) => dispatch(PaymentActions.cardHistory(page)),
...
export default connect(mapStateToProps, mapDispatchToProps)(CardVerifyPoint)