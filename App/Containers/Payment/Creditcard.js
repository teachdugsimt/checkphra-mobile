...
class Creditcard extends Component {
        ...
        return {
            headerLeft: (
                <TouchableOpacity onPress={() => navigation.goBack()} style={{ flexDirection: 'row' }}>
                    ...
                    <Text style={{ marginLeft: 20, fontSize: 18, fontFamily: "Prompt-SemiBold", color: Colors.brownText }}>Credit-Card</Text>
                </TouchableOpacity>
            )
        };
    };
    render(){
        return(
            <View>
                <Text style={{ alignSelf: 'center' }}>CREDIT CARD PAGE</Text>
                </View>
        )
    }
}
