...
class PickerMarket extends Component {
    // // Prop type warnings
    // static propTypes = {
...
const mapStateToProps = state => {
    return {
        images: state.market.data_image,
...
const mapDispatchToProps = dispatch => {
    return {
        setImages: (index, source) => dispatch(MarketActions.setImageMarket(index, source)),
        deleteImage: (index) => dispatch(MarketActions.deleteImageMarket(index)),
        // clearImage: () => dispatch(QuestionActions.clearImage()),
        // setUri: (data, index) => dispatch(QuestionActions.setUri(data, index)),
    };
};

export default connect(mapStateToProps, mapDispatchToProps)(PickerMarket);
