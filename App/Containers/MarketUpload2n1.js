...
class MarketUpload2n1 extends Component {
                        ...
                        return (
                            <View style={{ backgroundColor: '#fff5', padding: 10, borderRadius: 10, marginTop: 10, marginHorizontal: 15 }}>
                                <Text style={{
                                    fontFamily: 'Prompt-Regular',
                                    fontSize: 16,
                                }}>{e.question == 1 ? I18n.t('trueFalse') : e.question == 2 ? I18n.t('pricePhra') : I18n.t('detailPhra')} : <Text style={{
                                    fontFamily: 'Prompt-SemiBold',
                                    fontSize: 18,
                                    color: Colors.brownTextTran
                                }}>{e.answer != 'ไม่ออกผล' ? e.answer : I18n.t('noneAnswer')}</Text></Text>
                            </View>
                        )
                    })}
...
export default connect(mapStateToProps, mapDispatchToProps)(MarketUpload2n1)
