        ...
        <View style={{ flex: 0.63 }}>
          <ScrollView>
            ...
            {this.state.updateData && this.state.updateData.status == 'approve' ? <View style={{ alignItems: 'center' }}>
              <Text style={{ fontSize: 18, color: 'green', fontFamily: 'Prompt-SemiBold', alignSelf: 'center', marginTop: 15 }}>{this.state.updateData.recent_bid == 'admin' ? I18n.t('userAccept') : I18n.t('adminAccept')}</Text>

              <View style={{ backgroundColor: '#fff9', borderRadius: 10, padding: 10 }}>
                <Text style={{ fontSize: 16, color: Colors.brownText, fontFamily: 'Prompt-SemiBold', alignSelf: 'center', marginTop: 5 }}>{I18n.t('address')} : Thai Great Amulet</Text>
              ...
              <View style={{ alignItems: 'center' }}>
                <Text style={{ fontSize: 18, color: 'green', fontFamily: 'Prompt-SemiBold', alignSelf: 'center', marginTop: 15 }}>{this.props.data.recent_bid == 'admin' ? I18n.t('userAccept') : I18n.t('adminAccept')}</Text>
